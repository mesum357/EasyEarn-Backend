...
import { ActivationEnergyCalculator } from "@/components/calculators/activation-energy-calculator";
...
export default function ActivationEnergyCalculatorPage() {
    ...
    <div className="container py-12">
      <div className="relative flex items-center justify-between mb-8 bg-card p-4 rounded-lg shadow-sm">
        ...
        <div className="flex-1 text-center">
          <h1 className="text-2xl md:text-3xl font-bold font-headline">Activation Energy Calculator</h1>
        </div>
        <AlertDialog>
