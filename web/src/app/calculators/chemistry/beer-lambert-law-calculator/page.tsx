...
import { BeerLambertLawCalculator } from "@/components/calculators/beer-lambert-law-calculator";
...
export default function BeerLambertLawCalculatorPage() {
    ...
    <div className="container py-12">
      <div className="relative flex items-center justify-between mb-8 bg-card p-4 rounded-lg shadow-sm">
        ...
        <div className="flex-1 text-center">
          <h1 className="text-2xl md:text-3xl font-bold font-headline">Beer-Lambert Law Calculator</h1>
        </div>
        <AlertDialog>
