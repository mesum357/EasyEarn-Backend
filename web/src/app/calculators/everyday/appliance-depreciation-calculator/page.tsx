...
import { ApplianceDepreciationCalculator } from "@/components/calculators/appliance-depreciation-calculator";
...
export default function ApplianceDepreciationCalculatorPage() {
    ...
    <div className="container py-12">
      <div className="relative flex items-center justify-between mb-8 bg-card p-4 rounded-lg shadow-sm">
        ...
        <div className="flex-1 text-center">
          <h1 className="text-2xl md:text-3xl font-bold font-headline">Appliance Depreciation Calculator</h1>
        </div>
        <AlertDialog>
      ...
      <div className="flex justify-center mb-8">
        <ApplianceDepreciationCalculator />
      </div>
      <CalculatorInfo />
    </div>
  );
