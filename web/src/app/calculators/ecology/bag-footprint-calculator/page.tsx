...
import { BagFootprintCalculator } from "@/components/calculators/bag-footprint-calculator";
...
export default function BagFootprintCalculatorPage() {
    ...
    <div className="container py-12">
      <div className="relative flex items-center justify-between mb-8 bg-card p-4 rounded-lg shadow-sm">
        ...
        <div className="flex-1 text-center">
          <h1 className="text-2xl md:text-3xl font-bold font-headline">Bag Footprint Calculator</h1>
        </div>
        <AlertDialog>
